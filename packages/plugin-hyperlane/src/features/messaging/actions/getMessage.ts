/**
 * /packages/plugin-hyperlane/src/features/messaging/actions/getMessage.ts
 *
 * Action handler for retrieving cross-chain messages.
 * Fetches and validates message status and content.
 */
...
import { HyperlaneMessage } from "@core/types/message";
