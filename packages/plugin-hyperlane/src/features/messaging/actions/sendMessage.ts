/**
 * /packages/plugin-hyperlane/src/features/messaging/actions/sendMessage.ts
 *
 * Action handler for sending cross-chain messages.
 * Processes user commands to send arbitrary messages between chains using Hyperlane's messaging protocol.
 */
...
import { createMessageDispatchProvider } from "@features/messaging/providers";
