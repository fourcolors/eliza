/**
 * /packages/plugin-hyperlane/src/features/messaging/actions/verifyMessage.ts
 *
 * Action handler for verifying cross-chain messages.
 * Validates message authenticity and processing status.
 */
...
import { IsmProvider } from "@features/messaging/providers/createIsmProvider";
import { ActionResult } from "@core/types/action";
import { MessageStatus } from "@core/types/message";
